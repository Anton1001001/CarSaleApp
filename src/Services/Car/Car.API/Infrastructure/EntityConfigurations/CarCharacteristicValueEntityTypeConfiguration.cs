...
public class CarCharacteristicValueEntityTypeConfiguration : IEntityTypeConfiguration<CarCharacteristicValue>
{
    public void Configure(EntityTypeBuilder<CarCharacteristicValue> builder)
    {
        ...
        builder.HasIndex(
            e => new
            {
                IdCarCharacteristic = e.CarCharacteristicId, IdCarModification = e.CarModificationId, IdCarType = e.CarTypeId
            }, "id_car_characteristic").IsUnique();

        builder.HasIndex(e => e.CarTypeId, "id_car_type");

        builder.HasIndex(e => new { IdCarCharacteristic = e.CarCharacteristicId, IdCarModification = e.CarModificationId },
            "id_characteristic").IsUnique();

        builder.Property(e => e.Id).HasColumnName("id_car_characteristic_value");
