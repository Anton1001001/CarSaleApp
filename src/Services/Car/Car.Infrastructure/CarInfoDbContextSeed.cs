...
// public class CarInfoDbContextSeed(IHostEnvironment env, ICsvParser csvParser) : IDbSeeder<CarInfoDbContext>
// {
//     public async Task SeedAsync(CarInfoDbContext context)
//     {
//         var contentRootPath = env.ContentRootPath;
//         contentRootPath = Path.Combine(contentRootPath, "..", "Car.Infrastructure");
//
